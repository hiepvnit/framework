 ...
 */
namespace Mage2\Framework\Attribute\Controllers\Admin;

use Mage2\Attribute\Models\ProductAttribute;
use Mage2\Framework\System\Controllers\AdminController;
use Mage2\Framework\DataGrid\Facades\DataGrid;
use Mage2\Attribute\Requests\AttributeRequest;
...
class AttributeController extends AdminController
{
    ...
    {
        return $users = DataGrid::dataTableData(ProductAttribute::query())->get();
    }

    public function index()
    {
        return view('mage2-framework::admin.attribute.index');
    }

    public function create()
    {
        return view('mage2-framework::admin.attribute.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('mage2-framework::admin.attribute.edit')->with('attribute', $attribute);
    ...
    public function getAttribute(Request $request)
    {
        ...
        return view('mage2-framework::admin.attribute.attribute-panel-values')
